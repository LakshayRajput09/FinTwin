...
export default function Financing() {
  ...
  // EMI Chart Data
  const emiPieData = [
    { name: "Principal Loan Amount", value: emiLoanAmount, fill: "#1F5A4A" },
  ...
  const trajectoryData = Array.from({ length: 12 }, (_, i) => {
    ...
    return {
      ...
      "With FinTwin Capital": Math.round(cashWith),
    };
  });
  ...
  const handleExportLoanDossier = () => {
    const csvContent =
      ...
      [
        ...
        "",
        "Generated by FinTwin AI Digital Twin - Compliant with RBI/MoMSME Credit Norms",
      ].join("\n");

    const encodedUri = encodeURI(csvContent);
    const link = document.createElement("a");
    link.setAttribute("href", encodedUri);
    link.setAttribute("download", `FinTwin_MSME_Loan_Proposal_Dossier.csv`);
                ...
                <div style={{ height: 110, width: "100%", marginTop: 10 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      />
                      <Bar dataKey="Principal" stackId="a" fill="#1F5A4A" radius={[4, 0, 0, 4]} />
                      <Bar dataKey="Interest" stackId="a" fill="#B54747" radius={[0, 4, 4, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <div className="card-icon-wrap emerald" style={{ width: 40, height: 40 }}>
                        <Zap size={20} style={{ color: "#2E7D5B" }} />
                      </div>
                      <div>
